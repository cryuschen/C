...
- [运行脚本](decoder_v3_erp.py)、[成对增量审计](decoder_v3_incremental_audit.py)、[数据流测试](../tests/test_q2_decoder_v3_erp.py)。
- [每组与合并完整指标](../Q2_decoder_v3_erp/metrics.csv)、[逐试次预测](../Q2_decoder_v3_erp/oof_predictions.csv)、[逐试次 18 维折外特征](../Q2_decoder_v3_erp/oof_features.csv)。
- [全部置换零分布](../Q2_decoder_v3_erp/permutation_null.csv)、[成对增量数值](../Q2_decoder_v3_erp/incremental_audit.json)、[输入哈希与参数清单](../Q2_decoder_v3_erp/manifest.json)、[实际检查过的结果图](../Q2_decoder_v3_erp/decoder_v3_erp.png)。
...
/home/cryus/code-project/ML/.venv/bin/python -m unittest tests/test_q2_decoder_v3_erp.py -v
```
